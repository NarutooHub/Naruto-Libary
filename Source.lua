...
local redzlib = {
  Themes = {
    ...
    Orange = {
      ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(51, 36, 0)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(51, 36, 0)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(51, 36, 0))
      }),
