...
local redzlib = {
  Themes = {
    ...
    Orange = {
      ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(100, 43, 0)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(100, 43, 0)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(100, 43, 0))
      }),
      ["Color Hub 2"] = Color3.fromRGB(255, 145, 29),
      ["Color Stroke"] = Color3.fromRGB(255, 145, 29),
